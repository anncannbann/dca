"""
Problem Statement:-  
Chacha is playing an arcade game and wants to climb to the top of the leader board and wants 
to track her ranking. The game uses Dense Ranking so its leader board works like this:
...
For example, the four players on the leader board have high scores of 100, 90, 90, and 80. 
